...
import infoAreaPhoneStyle from "./infoAreaPhoneStyle";

const useStyles = makeStyles(infoAreaPhoneStyle);

export default function InfoAreaPhone(props) {
...
InfoAreaPhone.defaultProps = {
  iconColor: "gray"
};

InfoAreaPhone.propTypes = {
