        ...
        <GridContainer justifyContent="center" >
          <GridItem md={5} lg={5} sm={12} xs={12}>
            ...
            <h5 className={classes.description}>
              Have a system that <strong>handles everything for you</strong> - attracting new clients, handling move-in logistics, and communicating
              with guests and contractors. Finally allow your rental property to be what you've always wanted it to be:
              a passive investment vehicle that makes you money and frees up time so you can <strong>focus on what really matters- living your life.</strong>
            </h5>
          </GridItem>
